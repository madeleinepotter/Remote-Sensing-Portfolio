...
![Mexican Gulf Coast The image on the left is impacted by smoke effects from agriculture, the image on the right is the result of atmospheric correction (Groeneveld, Ruggles and Gao, 2023).](images/Screenshot 2024-01-25 164333.png){alt="Mexican Gulf Coast The image on the left is impacted by smoke effects from agriculture, the image on the right is the result of atmospheric correction (Groeneveld, Ruggles and Gao, 2023)." fig-align="center" width="497"}
...
![The left image is an uncorrected image and the one on the right is the geo-referenced image after geometric correction (Arif, 2009).](images/Screenshot 2024-01-25 164530.png){alt="The left image is an uncorrected image and the one on the right is the geo-referenced image after geometric correction (Arif, 2009)."}
