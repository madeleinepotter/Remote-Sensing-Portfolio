...
![Mexican Gulf Coast The image on the left is impacted by smoke effects from agriculture, the image on the right is the result of atmospheric correction (Groeneveld, Ruggles and Gao, 2023).](images/Screenshot%202024-01-25%20164333.png){fig-align="center" width="497"}
...
![The left image is an uncorrected image and the one on the right is the geo-referenced image after geometric correction (Arif, 2009).](images/Screenshot%202024-01-25%20164530.png)
