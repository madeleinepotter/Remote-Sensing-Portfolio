...
![](Screenshot 2024-02-01 093141.png){fig-align="center" width="437"}
...
![](Screenshot 2024-02-01 093418.png){fig-align="center" width="278"}
...
Differential Interferometry Synthetic Aperture Radar (DInSAR) observes changes between two SAR images taken at different times and is often used to measure land subsidence. Calo et al. (2017) used DinSAR along with data on land cover, climate, and water storage in Turkey to correlate land subsidence to groundwater extraction.  In Jakarta, the use of such techniques could help identify areas with high rates of land subsidence allowing for necessary action taken before it can worsen the intensity of flood events.
